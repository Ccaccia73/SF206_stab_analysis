...
\begin{figure}[htb]
	\centering
	\subfloat[mesh: pannelli]{\includegraphics[width=.90\columnwidth]{mesh1.jpg}\label{fig:mesh1}} \\
	\subfloat[mesh: centine e longheroni]{\includegraphics[width=.90\columnwidth]{mesh2.jpg}\label{fig:mesh2}} \\
	\subfloat[mesh: elementi beam]{\includegraphics[width=.90\columnwidth]{mesh3.jpg}\label{fig:mesh3}} \\
...
\begin{figure}[tb]
	\centering
	\subfloat[Sezione 1]{\includegraphics[width=.45\columnwidth]{sect1.jpg}} \quad
	\subfloat[Sezione 2]{\includegraphics[width=.45\columnwidth]{sect2.jpg}} \\
	\subfloat[Sezione 3]{\includegraphics[width=.45\columnwidth]{sect3.jpg}} \quad
	\subfloat[Sezione 4]{\includegraphics[width=.45\columnwidth]{sect4.jpg}} \\
	\subfloat[Sezione 5]{\includegraphics[width=.45\columnwidth]{sect5.jpg}} \\
...
\begin{figure}[htb]
	\centering
	\subfloat[manovra]{\includegraphics[width=.48\columnwidth]{01_dati_manovra.jpg}} \
	\subfloat[raffica]{\includegraphics[width=.48\columnwidth]{01_dati_raffica.jpg}} \\
...
Tale forza ha un braccio di $40mm$ dal longherone principale e viene modellata tramite un elemento \emph{RBE3} che agisce su una regione del longherone principale corrispondente all'attacco dell'equilibratore.\\

Le componenti rimanenti sono considerate forze distribuite e si può verificare la relazione $T_y = \frac{dM_x}{dz}$ (cfr. figura \ref{fig:az_distr}):

\begin{figure}[htb]
	\centering
	\subfloat[az. distribuite manovra]{\includegraphics[width=.48\columnwidth]{02_azioni_distribuite_manovra.jpg}} \
	\subfloat[az. distribuite raffica]{\includegraphics[width=.48\columnwidth]{02_azioni_distribuite_raffica.jpg}} \\
	\subfloat[verifica manovra]{\includegraphics[width=.48\columnwidth]{03_verifica_manovra.jpg}} \
	\subfloat[verifica raffica]{\includegraphics[width=.48\columnwidth]{03_verifica_raffica.jpg}} \\
...
Per caricare la struttura si possono adottare diverse filosofie. Si è scelto qui di considerare e seguenti casi:
...
\begin{enumerate}
	...
	\item Caricare con una forza superficiale costante per ogni tratto dei \emph{longheroni}. Riproduce $T_y$ in modo fedele, tuttavia l'assenza del longherone anteriore nei tratti 4 e 5 rende molto approssimato $M_z$ nel tratto finale.
\end{enumerate} 
...
\begin{figure}[htb]
	\centering
	\subfloat[$T_y$ manovra]{\includegraphics[width=.48\columnwidth]{04_Ty_centine_manovra.jpg}} \
	\subfloat[$T_y$ raffica]{\includegraphics[width=.48\columnwidth]{04_Ty_centine_raffica.jpg}} \\
	\subfloat[$M_x$ manovra]{\includegraphics[width=.48\columnwidth]{05_Mx_centine_manovra.jpg}} \
	\subfloat[$M_x$ raffica]{\includegraphics[width=.48\columnwidth]{05_Mx_centine_raffica.jpg}} \\
	\subfloat[$M_z$ manovra]{\includegraphics[width=.48\columnwidth]{06_Mz_centine_manovra.jpg}} \
	\subfloat[$M_z$ raffica]{\includegraphics[width=.48\columnwidth]{06_Mz_centine_raffica.jpg}} \\
...
\begin{figure}[htb]
	\centering
	\subfloat[$T_y$ manovra]{\includegraphics[width=.48\columnwidth]{07_Ty_distribuito_manovra.jpg}} \
	\subfloat[$T_y$ raffica]{\includegraphics[width=.48\columnwidth]{07_Ty_distribuito_raffica.jpg}} \\
	\subfloat[$M_x$ manovra]{\includegraphics[width=.48\columnwidth]{08_Mx_distrib_manovra.jpg}} \
	\subfloat[$M_x$ raffica]{\includegraphics[width=.48\columnwidth]{08_Mx_distrib_raffica.jpg}} \\
	\subfloat[$M_z$ manovra]{\includegraphics[width=.48\columnwidth]{09_Mz_distrib_manovra.jpg}} \
	\subfloat[$M_z$ raffica]{\includegraphics[width=.48\columnwidth]{09_Mz_distrib_raffica.jpg}} \\
