...
\begin{figure}[tb]
	\centering
	\subfloat[Sezione 1]{\includegraphics[width=.45\columnwidth]{Lorem}} \quad
	\subfloat[Sezione 2]{\includegraphics[width=.45\columnwidth]{Ipsum}} \\
	\subfloat[Sezione 3]{\includegraphics[width=.45\columnwidth]{Dolor}} \quad
	\subfloat[Sezione 4]{\includegraphics[width=.45\columnwidth]{Sit}} \\
	\subfloat[Sezione 5]{\includegraphics[width=.45\columnwidth]{Sit}} \\
